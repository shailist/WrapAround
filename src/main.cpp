...
// configuration step. It creates a namespace called `WrapAround`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        WrapAround::cmake::project_name,
        WrapAround::cmake::project_version));// version string, acquired
